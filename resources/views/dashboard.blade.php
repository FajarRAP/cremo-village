        ...
        <nav
            ...
            <div class="flex flex-wrap justify-between items-center">
                <div class="flex justify-start items-center">
                    ...
                    <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Dusun
                        Cremo</span>
                </div>
                        ...
                        <ul class="py-1 text-gray-700 dark:text-gray-300" aria-labelledby="dropdown">
                            <li>
                                <a href="{{ route('profile.edit') }}"
                                    class="block py-2 px-4 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-400 dark:hover:text-white">{{ __('Account settings') }}</a>
                            </li>
                        </ul>
                        <ul class="py-1 text-gray-700 dark:text-gray-300" aria-labelledby="dropdown">
                            <li>
                                <form method="POST" action="{{ route('logout') }}">
                                    ...
                                    <a href="{{ route('logout') }}"
                                        ...
                                        class="block py-2 px-4 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 hover:rounded-b-lg dark:hover:text-white">{{ __('Log out') }}</a>
                                </form>
                            </li>
                        </ul>
                    </div>
                ...
                <ul class="space-y-2">
                    ...
                    <li>
                        <a href="#"
                            ...
                            <span class="flex-1 ml-3 text-left whitespace-nowrap">Catatan Penduduk</span>
                        </a>
                    </li>
                    <li>
                        <a href="#"
                    ...
                    <li>
                        <a href="#"
                            ...
                            <span class="flex-1 ml-3 text-left whitespace-nowrap">Buku Tamu</span>
                        </a>
                    </li>
                </ul>
            </div>
