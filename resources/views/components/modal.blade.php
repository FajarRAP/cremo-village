...
<div x-data="{
    ...
    x-on:keydown.shift.tab.prevent="prevFocusable().focus()" class="relative z-50">
    <div class="fixed inset-0 bg-gray-500/75 transition-opacity" x-show="show" x-transition:enter="ease-out duration-300"
